...
const iitmMath2QuestionsSchema = new mongoose.Schema({
  question_number: {
    type: Number,
    required: true
  },
...
iitmMath2QuestionsSchema.pre('save', function(next) {
  this.updated_at = Date.now();
  next();
});

module.exports = mongoose.model('iitm_maths2_questions_databases', iitmMath2QuestionsSchema);
